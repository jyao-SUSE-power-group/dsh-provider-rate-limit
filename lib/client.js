window.__ModuleLoader__.load({
	...
	function draftIssues(draft) {
		...
		function statsSection(stats, t) {
			...
			return jsxs("div", { className: "rl_statsCard", children: [
				...
				jsxs("div", { className: "rl_statsGrid", children: [
					...
					jsxs("div", { className: "rl_statItem", children: [
						jsx("span", { className: "rl_statVal", children: String(agg.waited || 0) }),
		...
		function apply(ctx) {
			...
			// controller's stats state directly on a 1s local tick — no hook
			// mapping, no cross-plugin contract, mirrors the shipped stats line.
			const ComposerStatsLine = () => {
				const [snap, setSnap] = react.useState(controller.statsState);
				react.useEffect(() => {
					const tick = setInterval(() => setSnap(controller.statsState), 1000);
				...
				const routes = Object.keys(snap.data.routes || {}).length;
				...
				return jsxs("div", {
					...
					children: [
						...
						jsx("span", { children: `${t("statsRejected")} ${agg.rejected || 0} \u00b7 ${t("statsWaited")} ${agg.waited || 0} \u00b7 ${t("statsAvgWait")} ${avg} \u00b7 ${t("statsTotal")} ${agg.reserved || 0} \u00b7 ${t("statsRoutes")} ${routes}` })
					]
				});
			};
